...
<form action="marks_process.jsp">
	...
	Student_name :: 	
		...
		&nbsp;&nbsp;&nbsp;<input type="button" value="Add/Insert" onclick="Redirect()" id="stud_add">
		<br/>
	...
	Subject_name :: &nbsp; 	
		...
		&nbsp;&nbsp;&nbsp;<input type="button" value="Add/Insert" onclick="Redirect()" id="sub_add">
		<br/>
		
	
	<br/>
	Marks :: <input type="text" name="mrk"> 
	&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="change" size="3" name="val" readonly/>Out_Of<br/><br/>
...
<script type="text/javascript">
		...
		function Redirect() 
		{
			...
			else if(document.getElementById("sub_add"))
