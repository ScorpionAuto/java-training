...
<title>Marks.jsp</title>   
</head>

<body onload='document.form1.text1.focus()'>
	
<%@include file="marks.css" %>

<div align='center'>
	<div class='main'>
	
		<div id='heading'>
				<h2>Marks Input Table</h2>
		...
		<div class='section'>
			...
			<span id="buton"><input type="button" value="Add/Insert" onclick="new1()" id="stud_add"></span>
			...
			<span id="buton"><input type="button" value="Add/Insert" onclick="new2()" id="sub_add"></span>
			
			
			
			<span id='data'>Marks :</span>
			<span id='box'><input type='text' name='text1' size='17px'> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type='text' id='change' size='10' name='text2' readonly> <span style='padding-left:5px;font-size:17px;font-weight:bold;clear:right;'>Out_Of </span></span>
